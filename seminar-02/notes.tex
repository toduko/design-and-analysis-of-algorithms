...
В зависимост от това къде се намира \mintinline{c++}|value| във \mintinline{c++}|array|, алгоритъма може да приключи много бързо или много бавно.
...
Нека сега да помислим какво ще стане в най-лошият случай (обикновено от тези ще се интересуваме) -- \mintinline{c++}|value| не участва в \mintinline{c++}|array|.
...
\begin{itemize}
    ...
    \item инкрементираме \mintinline{c++}|i|
\end{itemize}
